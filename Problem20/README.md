...
<details>
  <summary>Implementation Comments (Spoilers!)</summary>
  Something that was interesting, though, was how the sample input's "image enhancement algorithm" had <code>.</code> as the first character, but I had <code>#</code> instead. That basically led me to having to think about how many times I added padding, and if I had to remove padding or not. I also had that on turn 1, the <code>#</code> padding is added, instead of the intended <code>.</code>. That threw me off a bit and led to a short debugging session.
</details>
